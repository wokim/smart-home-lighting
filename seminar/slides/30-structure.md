...
<tr><td class="grp">동시성</td><td>그룹 명령으로 동시. 외부에서 등 하나씩 명령하면 팝콘</td><td>허브 씬은 동시. 외부(HA·Matter)에서 개별 명령하면 <strong>팝콘</strong></td><td>Wi-Fi형은 기기별 개별 제어라 <strong>팝콘이 기본</strong>. Zigbee형은 허브 그룹 가능</td><td>그룹·씬 명령은 버스 전체 동시, <strong>누락 없음</strong></td></tr>
