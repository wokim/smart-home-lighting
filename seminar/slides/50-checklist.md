...
<p class="muted" style="font-size:.58em;margin-top:.6em">유인물에 같은 내용이 항목별 설명과 함께 들어 있다</p>

Note: 여기까지 한 얘기를 표로 모았다. 화면에서 다 읽을 필요는 없고 유인물로 가져가시면 된다. 강조할 것 셋만. 제어 방식은 유선이면 전기공사 전이 마지막 기회다. 중성선은 스위치 박스마다 넣어야 나중에 무엇이든 할 수 있다. 그리고 준공 시점의 시나리오는 초안이라는 걸 계약 단계에서 서로 합의해 두는 것.
